          ...
          <div className="flex w-full flex-col items-center justify-center gap-6">
            <div className="section-text-block">
              <p>
                ...
                traditional approaches to leverage, SIR does away with
                maintenance fees and removes{" "}
                <Link
              ...
              <p>
                Users pay a fixed amount when they open or close a position , in
                contrast with many platforms that charge ongoing fees, eating
        ...
        <Section variant="background" header={"Permissionless & Trustless"}>
          <div className="section-text-block">
            <p>
              ...
              trustless and permissionless. Like Uniswap, anyone can create a
              vault , specifying a pair of tokens and a leverage ratio.
            </p>

            <p>
              The protocol runs on immutable smart contracts with fixed
              parameters, eliminating risks from unexpected changes. After its
              beta phase, SIR&#39;s unstoppable code will be completely
