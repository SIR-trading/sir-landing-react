...
const bullets = [
  {
    ...
    text: (
      <>
        ...
        <span className="text-redAccent font-semibold">mainnet relaunch</span>.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <span className="text-redAccent font-semibold">paid out in ETH</span>.
        ...
        <div className="flex w-full flex-col items-center gap-20 md:flex-row md:items-start md:justify-evenly md:gap-6">
          {bullets.map((bullet) => (
            <div key={bullet.i} className={"flex flex-col"}>
              <div
                slot="header"
                className="text-rob-roy-300 ring-rob-roy-300 mx-auto w-max rounded-xl px-4 py-3 text-center font-black ring-2"
              >
                {bullet.i}
              </div>
